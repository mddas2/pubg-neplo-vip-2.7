...
namespace ImGui
{
    ...
    inline void RenderArrow(ImVec2 pos, ImGuiDir dir, float scale=1.0f) { ImGuiWindow* window = GetCurrentWindow(); RenderArrow(window->DrawList, pos, GetColorU32(ImVec4(0.947f, 0.392f, 0.014f, 1.000f)), dir, scale); }
    inline void RenderBullet(ImVec2 pos)                                { ImGuiWindow* window = GetCurrentWindow(); RenderBullet(window->DrawList, pos, GetColorU32(ImVec4(0.947f, 0.392f, 0.014f, 1.000f))); }
#endif
    ...
    bool sub2(const char* label, bool selected);
    bool sub3(const char* label, bool selected);
    bool sub4(const char* label, bool selected);
